...
public class MIController {
    ...
    public void communityImageUpload(HttpServletRequest request, HttpServletResponse response, @RequestParam MultipartFile upload) {
        ...
        try{
            ...
            String uploadPath = "C:\\study\\workspace\\spring\\movie_inside_project\\src\\main\\webapp\\resources\\photoUpload\\" + fileName;//저장경로
            ...
            String fileUrl = "/resources/photoUpload/" + fileName;//url경로
